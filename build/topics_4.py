...
{'t':'Местоимения и люди','sc':'office','cd':'A1: Can refer to people correctly.','w':[
 ...
 ('no one','никто'),('group','группа'),('part','часть'),('member','участник'),('own','собственный'),('saw','увидел'),],
...
{'t':'Быт: мелочи','sc':'flat','cd':'A1: Can handle small everyday matters.','w':[
 ...
 ('use','использовать'),('need','нужно'),('want','хотеть'),('have','иметь'),('own','иметь свой'),('bit','немного'),],
...
{'t':'Прошлое','sc':'cafe','cd':'A1: Can talk about the past simply.','w':[
 ...
 ('finish','закончил'),('start','начал'),('leave','уехал'),('come','пришёл'),('meet','встретил'),('forgot','забыл'),('went','пошёл / прошёл'),],
